...
from credit_model.pipeline import credit_pipe
from credit_model.processing.data_manager import load_dataset, save_pipeline
...
def run_training() -> None:
    ...
    # Pipeline fitting
    credit_pipe.fit(X_train, y_train)
    ...
    save_pipeline(pipeline_to_persist = credit_pipe)
